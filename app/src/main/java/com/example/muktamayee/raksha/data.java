...
public class data extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_EMER_NAME = "Emergency_name";
    ...
    private String CREATE_EMER_TABLE = "CREATE TABLE " + TABLE_EMER + "("
            + COLUMN_EMER_PHONENUMBER + " INTEGER PRIMARY KEY ," + COLUMN_EMER_NAME + " TEXT" + ")";


    // drop table sql query
    private String DROP_USER_TABLE = "DROP TABLE IF EXISTS " + TABLE_USER;
    private String DROP_EMER_TABLE = "DROP TABLE IF EXISTS " + TABLE_USER;
